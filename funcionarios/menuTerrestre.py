...
# Classe referente a tela do funcionario terrestre
class MenuTerrestre(FuncionarioFun):
    def __init__(self):
        self.animais = []
        self.root = Tk()
        self.tela()
    ...
    def tela(self):  # Cria a tela
        self.root.title("Tela Funcionario Terrestre")
    ...
    def lista(self):  # Cria o Treeview para visualizar todos os animais terrestres
    ...
    def buttonsFrame(self):  # Cria os botões da tela
        ...
        self.edit_Animal_button = Button(
            self.frame1, text="Buscar", command=self.buscarAnimalTerrestre)
