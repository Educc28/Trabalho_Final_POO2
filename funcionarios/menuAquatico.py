...
class MenuAquatico(FuncionarioFun):  # Classe referente a tela do funcionario aquatico
    def __init__(self):
        self.animais = []
        self.root = Tk()
        self.tela()
    ...
    def tela(self):  # Cria a tela
        self.root.title("Tela Funcionario Aquatico")
    ...
    def lista(self):  # Cria o Treeview para visualizar todos os animais aquaticos
    ...
    def campos(self):  # Cria as labels e entries da tela
        ...
        self.temperatura_label = Label(
            self.frame1, text="Temperatura:", anchor='w')
        self.temperatura_label.place(relx=0, rely=0.2)
        self.temperatura_entry = Entry(self.frame1)
        self.temperatura_entry.place(relx=0.07, rely=0.2)
    ...
    def buttonsFrame(self):  # Cria os botões da tela
        ...
        self.deleteAnimal_button.place(relx=0.425, rely=0.55, anchor='w')

        self.edit_Animal_button = Button(
            self.frame1, text="Ajustar Temperatura", command=self.ajustaTemperatura)
        self.edit_Animal_button.place(relx=0.498, rely=0.55, anchor='w')

        self.edit_Animal_button = Button(
            self.frame1, text="Buscar", command=self.buscarAnimalAquaticos)
